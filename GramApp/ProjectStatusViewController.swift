...
class ProjectStatusViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func setCheckmark(at indexpathRow: Int) {
        switch indexpathRow {
        case 0:
            notCompletedCell.checkmarkImageView.image = UIImage(named: "Image")
            completedCell.checkmarkImageView.image = nil
        case 1:
            notCompletedCell.checkmarkImageView.image = nil
            completedCell.checkmarkImageView.image = UIImage(named: "Image")
        default:
            fatalError("default not allowed!")
        }
    }
